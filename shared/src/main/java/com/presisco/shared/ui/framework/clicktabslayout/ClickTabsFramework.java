package com.presisco.shared.ui.framework.clicktabslayout;
...
public class ClickTabsFramework extends Fragment {
    ...
    public void setID(int layout_id, int tab_layout_id, int scroll_id, int content_id) {
        mMainLayout = layout_id;
        mTabLayout = tab_layout_id;
        mScrollId = scroll_id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(mMainLayout, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mScroll = (ClickTabsContainer) view.findViewById(mScrollId);
    ...
    public void goTab(int pos) {
        ...
        trans.replace(mContentId, mContentItems.get(pos));
        trans.commit();
        lastTabPos = pos;
        lastTab = now;
    }
