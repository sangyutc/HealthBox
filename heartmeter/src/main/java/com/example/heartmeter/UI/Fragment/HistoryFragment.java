...
public class HistoryFragment extends BaseHistoryFragment implements BaseHistoryFragment.ActionListener {
        ...
        mAnalyseModes = new TypedHistoryMode[]{
                new TypedHistoryMode() {
                    ...
                    public void displayResult() {
                        ...
                        panel.setAxisYScale(20, 200);
                        panel.setMaxPoints(60);
                        panel.setXStep(1);
                        panel.setAxisXText("时间");
                        panel.setAxisYText("心率");
                        panel.setScrollable(true);
                        // panel.redraw();
                        float[] data = new float[raw_data.length];
                        for (int i = 0; i < raw_data.length; ++i) {
                            data[i] = raw_data[i].heart_rate;
                        }
                ...
                new TypedHistoryMode() {
                    ...
                    public void analyseData(EventData[] data, int analyse_rate) {
                        ...
                        for (int i = 0; i < data.length; ++i) {
                            if (data[i].heart_rate > 100) {
                                counter[2]++;
                            } else if (data[i].heart_rate > 80) {
                                counter[1]++;
                            } else {
                                counter[0]++;
                            }
                ...
                new TypedHistoryMode() {
                    ...
                    public void analyseData(EventData[] data, int analyse_rate) {
                        ...
                        int[] counter = new int[]{0, 0, 0};
                        for (int i = 0; i < data.length; ++i) {
                            if (data[i].heart_rate > 120) {
                                counter[2]++;
                            } else if (data[i].heart_rate > 90) {
                                counter[1]++;
                            } else {
                                counter[0]++;
                            }
                ...
                new TypedHistoryMode() {
                    ...
                    public void analyseData(EventData[] data, int analyse_rate) {
                        ...
                        int[] counter = new int[]{0, 0, 0};
                        for (int i = 0; i < data.length; ++i) {
                            if (data[i].heart_rate > 70) {
                                counter[2]++;
                            } else if (data[i].heart_rate > 50) {
                                counter[1]++;
                            } else {
                                counter[0]++;
                            }
    ...
    /**
     * Created by presisco on 2017/5/8.
     */

    abstract static class TypedHistoryMode extends HistoryMode<EventData> {
